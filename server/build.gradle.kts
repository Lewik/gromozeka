...
tasks.withType<Test> {
    ...
    passSystemProperty("gromozeka.longmemeval.readPlannerModelName")
    passSystemProperty("gromozeka.longmemeval.readPlannerReasoningEffort")
    passSystemProperty("gromozeka.longmemeval.readSelectorModelName")
    passSystemProperty("gromozeka.longmemeval.readSelectorReasoningEffort")
