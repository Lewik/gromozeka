...
# Agent launcher script for: Репозитори-агент
# Generated by GenerateAgentLaunchersTest
# Description: Repository implementation
# Config: .gromozeka/agents/repository.json
...
# Print debug info
echo "Agent: Репозитори-агент (repository)"
echo "Config: .gromozeka/agents/repository.json"
echo "Prompts loaded:"
echo "  - env"
echo "  - prompts/common-prompt.md"
echo "  - .gromozeka/prompts/project-common-prompt.md"
echo "  - .gromozeka/prompts/repository-agent.md"
echo ""
...
Date: 2025-12-03T19:26:46.379924
