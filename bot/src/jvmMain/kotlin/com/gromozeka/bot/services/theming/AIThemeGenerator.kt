...
class AIThemeGenerator(
    ...
    private fun prepareInitialMessage(screenshotPath: String, aiWorkingDir: File): String {
        return try {
            ...
            val templateResource = this::class.java.getResourceAsStream("/ai-instructions/theme-generation-task-template.md")
            ...
            val lightThemeJson = jsonWithDefaults.encodeToString(com.gromozeka.bot.services.theming.data.LightTheme.serializer(), lightTheme)
            val darkThemeJson = jsonWithDefaults.encodeToString(com.gromozeka.bot.services.theming.data.DarkTheme.serializer(), darkTheme)
