...
data class ChineseTranslation(
    ...
    override val imageDisplayText: String = "[图片 %s - %d字符Base64]",
    ...
    override val runtime: RuntimeTranslation = RuntimeTranslation(
        title = "运行状态",
        closePanelDescription = "关闭运行面板",
        contextLabel = "上下文",
        lastUsageLabel = "最近",
        threadUsageLabel = "会话",
        cacheReadUsageLabel = "缓存读取",
        lastCallLabel = "最近调用",
        tokenUsageTitle = "令牌使用统计",
        collapseDescription = "收起",
        expandDescription = "展开",
        contextWindowLabel = "上下文窗口",
        tokensLabel = "令牌",
        recentTurnsLabel = "最近轮次",
        inputLabel = "输入",
        outputLabel = "输出",
        totalLabel = "总计",
        promptLabel = "提示词",
        ...
        readLabel = "读取",
        tasksTitle = "任务",
        claimedTaskLabel = "已领取",
        runningTaskLabel = "运行中",
        pendingTaskLabel = "等待中",
        toolTaskLabel = "工具",
        killButton = "终止",
        unknownTaskLabel = "未知",
        failedTaskLabel = "失败",
        queueTitle = "队列",
        currentTurnLabel = "当前轮次",
        afterResponseLabel = "回复后",
        editButton = "编辑",
        nearestToolResultPlacement = "在最近的工具结果之后",
        currentResponsePlacement = "在当前回复之后",
        voiceInputReadyStatus = "语音输入",
        startVoiceCaptureHint = "按住开始录音",
        preparingVoiceStatus = "正在准备麦克风",
        transcribingVoiceStatus = "正在转录语音...",
        recordingVoiceStatus = "正在录音",
        cancelVoiceCaptureHint = "松开取消",
        stopVoiceCaptureHint = "松开停止并转录",
        pauseRequestedStatus = "已请求暂停",
        pausedStatus = "已暂停",
        stoppingStatus = "正在停止",
        interruptingStatus = "正在中断",
        commandRunningStatus = "命令正在运行",
        commandsRunningStatus = "命令正在运行",
        toolsRunningStatus = "工具",
        agentWorkingStatus = "正在工作",
        queuedStatus = "队列中",
        readyStatus = "就绪",
        pauseButton = "暂停",
        resumeButton = "继续",
        ...
        memoryRecallTask = "记忆检索",
        executionIncidentTask = "执行故障",
        modelRequestStatus = "请求模型",
        toolExecutionStatus = "正在执行工具",
        toolResultProcessingStatus = "正在处理工具结果",
        memoryRecallStatus = "正在检索记忆",
        executionIncidentStatus = "正在处理执行故障",
        pendingDetailsLabel = "等待",
        incidentsDetailsLabel = "故障",
