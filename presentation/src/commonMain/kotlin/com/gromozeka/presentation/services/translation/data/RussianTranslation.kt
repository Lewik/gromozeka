...
data class RussianTranslation(
    ...
    override val quickActionGoogleSearch: String = "Загугли про Google",
    ...
    override val imageDisplayText: String = "[Изображение %s - %d символов Base64]",
    ...
    override val runtime: RuntimeTranslation = RuntimeTranslation(
        title = "Выполнение",
        closePanelDescription = "Закрыть панель выполнения",
        contextLabel = "Контекст",
        lastUsageLabel = "вызов",
        threadUsageLabel = "тред",
        cacheReadUsageLabel = "из кэша",
        lastCallLabel = "Последний вызов",
        usageTitle = "Использование",
        refreshUsageDescription = "Обновить использование",
        quotaUnavailableLabel = "Квота недоступна",
        quotaStaleLabel = "Устаревшие данные квоты",
        quotaUnlimitedLabel = "Без ограничений",
        quotaBlockedLabel = "Квота исчерпана",
        quotaResetLabel = "сброс через",
        quotaObservedLabel = "получено",
        quotaAgoLabel = "назад",
        backgroundQuotaPolicyLabel = "Политика фоновой квоты",
        tokenUsageTitle = "Использование токенов",
        collapseDescription = "Свернуть",
        expandDescription = "Развернуть",
        contextWindowLabel = "Окно контекста",
        tokensLabel = "токенов",
        recentTurnsLabel = "Последние turn",
        inputLabel = "ВХОД",
        outputLabel = "ВЫХОД",
        totalLabel = "Всего",
        promptLabel = "Промпт",
        ...
        hiddenThinkingLabel = "Скрытое размышление",
        createLabel = "Запись",
        readLabel = "Чтение",
        memoryTitle = "Память",
        memoryQueuedStatus = "В очереди",
        memoryRunningStatus = "В работе",
        memoryNeedsInputStatus = "Нужно уточнение",
        memoryCompletedStatus = "Готово",
        memoryFailedStatus = "Ошибка",
        memoryCancelledStatus = "Отменено",
        tasksTitle = "Задачи",
        claimedTaskLabel = "Взята",
        runningTaskLabel = "В работе",
        pendingTaskLabel = "Ожидает",
        toolTaskLabel = "Инструмент",
        killButton = "Убить",
        unknownTaskLabel = "Неизвестно",
        failedTaskLabel = "Ошибка",
        queueTitle = "Очередь",
        currentTurnLabel = "Текущий turn",
        afterResponseLabel = "После ответа",
        editButton = "Изменить",
        ...
        startVoiceCaptureHint = "Удерживайте для записи",
        preparingVoiceStatus = "Готовлю микрофон",
        transcribingVoiceStatus = "Расшифровываю голос...",
        recordingVoiceStatus = "Идёт запись голоса",
        cancelVoiceCaptureHint = "Отпустите, чтобы отменить",
        stopVoiceCaptureHint = "Отпустите, чтобы закончить и распознать",
        pauseRequestedStatus = "Пауза запрошена",
        pausedStatus = "На паузе",
        stoppingStatus = "Останавливается",
        interruptingStatus = "Прерывается",
        commandRunningStatus = "Команда выполняется",
        commandsRunningStatus = "Выполняются команды",
        monitorRunningStatus = "Монитор работает",
        monitorsRunningStatus = "Мониторы работают",
        monitorEventsLabel = "событий",
        monitorOnceMode = "однократно",
        monitorContinuousMode = "постоянно",
        commandsDetailsLabel = "команд",
        monitorsDetailsLabel = "мониторов",
        cancellingStatus = "Отменяется",
        toolsRunningStatus = "Инструменты",
        agentWorkingStatus = "работает",
        queuedStatus = "В очереди",
        readyStatus = "Готов",
        pauseButton = "Пауза",
        resumeButton = "Продолжить",
        stopButton = "Стоп",
        messagePostTask = "Публикация сообщения",
        agentInvocationTask = "Вызов агента",
        historyMutationTask = "Изменение истории",
        llmCallTask = "Вызов LLM",
        toolExecutionTask = "Выполнение инструмента",
        toolResultProcessingTask = "Обработка результата инструмента",
        memoryRecallTask = "Вспоминание",
        memoryRunCompletionTask = "Доставка результата памяти",
        backgroundActivityDeliveryTask = "Доставка фонового обновления",
        executionIncidentTask = "Сбой выполнения",
        modelRequestStatus = "Запрос к модели",
        historyMutationStatus = "Изменяется история диалога",
        toolExecutionStatus = "Выполняется инструмент",
        toolResultProcessingStatus = "Обработка результата инструмента",
        memoryRecallStatus = "Вспоминание",
        memoryRunCompletionStatus = "Передаю результат памяти",
        backgroundActivityDeliveryStatus = "Передаю фоновое обновление",
        executionIncidentStatus = "Обработка сбоя выполнения",
        pendingDetailsLabel = "ожидает",
        incidentsDetailsLabel = "сбои",
        ...
        activityGroupLabel = "Ход работы",
        readFileToolLabel = "Прочитать файл",
        writeFileToolLabel = "Записать файл",
        editFileToolLabel = "Изменить файл",
        executeCommandToolLabel = "Выполнить команду",
        webSearchToolLabel = "Поиск в интернете",
        localSearchToolLabel = "Локальный поиск",
        readUrlToolLabel = "Прочитать URL",
        createAgentToolLabel = "Создать агента",
        tellAgentToolLabel = "Передать агенту",
        switchTabToolLabel = "Переключить вкладку",
        listTabsToolLabel = "Список вкладок",
        testToolLabel = "Тест",
        listDisplaysToolLabel = "Список экранов",
        observeScreenToolLabel = "Просмотреть экран",
        useComputerToolLabel = "Управлять компьютером",
        captureScreenToolLabel = "Сделать снимок экрана",
        copyText = "Копировать",
