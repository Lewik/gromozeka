...
data class RussianTranslation(
    ...
    override val runtime: RuntimeTranslation = RuntimeTranslation(
        ...
        createLabel = "Запись",
        readLabel = "Чтение",
        catalogChangesTitle = "Агенты в репозитории изменились",
        catalogChangesDescription = "Импортировать все промпты и агентов из этого workspace в проект.",
        catalogSourceLabel = "Источник",
        catalogContentsLabel = "Каталог",
        catalogPromptsLabel = "промптов",
        catalogAgentsLabel = "агентов",
        catalogImportButton = "Импортировать всё",
        catalogSkipButton = "Пропустить",
        catalogInvalidLabel = "Импорт невозможен",
        tasksTitle = "Задачи",
