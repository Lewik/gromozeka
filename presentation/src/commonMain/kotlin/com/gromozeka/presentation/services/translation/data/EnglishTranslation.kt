...
data class EnglishTranslation(
    ...
    override val imageDisplayText: String = "[Image %s - %d chars Base64]",
    ...
    data class EnglishSettingsTranslation(
        ...
        override val showTabsAtBottomLabel: String = "Show tabs at bottom",
        ...
        override val showTabsAtBottomDescription: String = "Position tabs at the bottom of the window instead of at the top",
