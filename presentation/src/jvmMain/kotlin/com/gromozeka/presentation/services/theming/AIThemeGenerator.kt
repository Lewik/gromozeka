...
class AIThemeGenerator(
    ...
    private fun prepareInitialMessage(screenshotPath: String, aiWorkingDir: File): String {
        return try {
            ...
            val lightTheme = com.gromozeka.presentation.services.theming.data.LightTheme()
            val darkTheme = com.gromozeka.presentation.services.theming.data.DarkTheme()
            ...
            val lightThemeJson = jsonWithDefaults.encodeToString(
                com.gromozeka.presentation.services.theming.data.LightTheme.serializer(),
                lightTheme
            )
            val darkThemeJson = jsonWithDefaults.encodeToString(
                com.gromozeka.presentation.services.theming.data.DarkTheme.serializer(),
                darkTheme
            )
