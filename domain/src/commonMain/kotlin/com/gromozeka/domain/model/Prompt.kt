...
data class Prompt(
    ...
    sealed class Type {
        ...
        /**
         * Workspace-specific prompt stored in the mounted filesystem tree.
         * Versioned with workspace code.
         * ID format: "workspace:shared-base.md"
         */
        @Serializable
         ...
         * Contains project identity, workspace mount, platform info, git status, and current date.
         * Generated by SystemPromptBuilder.buildEnvironmentInfo()
         * Persisted by the runtime repository, not as a filesystem prompt file.
         */
        @Serializable
