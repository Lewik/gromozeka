 ...
 *
 * ## Name Normalization
 * [normalizedName] prevents duplicates from case/whitespace variations.
 * Normalization: `name.trim().lowercase()` - canonical form for MERGE operations.
 * [name] preserves original user input for display purposes.
 *
 * This is an immutable value type - use copy() to create modified versions.
 *
 * @property uuid unique entity identifier (UUIDv4)
 * @property name entity name as entered by user (e.g., "Gromozeka", "HYBRID Search", "  Kotlin  ")
 * @property normalizedName canonical form of name (lowercase, trimmed) for duplicate detection
